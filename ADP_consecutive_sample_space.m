function [Decision] = ADP_consecutive_sample_space(m,N,sample_space,sample_space_p,D,lambda_max,lambda_min,mu_max,mu_min,T_p,k_p,C,r_hat)
    ...
    if norm(D_k,1)==N & norm(D_k_p,1)< N
        while n1<= NS(1,1)
            ...
            if ok==1
                ...
                Revenue(n1,(m+1),k,d)=Addition(S(n1,1:end),C)+ max_revenue_state;
                Revenue(n1,1:m,k,d)=S(n1,1:end);
        ...
        if sum(S(n1,1:end))==N
            ...
            if ok==1
                ...
                if state_status==1
                           ...
                           Revenue(n1,(m+1),k,d)=Addition(S(n1,1:end),C)+ possible_Revenue_ca;
                           Revenue(n1,1:m,k,d)=S(n1,1:end);
