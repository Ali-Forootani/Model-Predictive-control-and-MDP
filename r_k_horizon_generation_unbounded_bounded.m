function [r_k_horizon]= r_k_horizon_generation_unbounded_bounded(m,N,sample_space...
,sample_length,lambda_max,lambda_min,mu_max,mu_min,C,D,F,T)
...
%n1=
while k >= 1
    [Revenue] = DP_Space_sampling_unbounded_bounded(m,N,sample_space(:,:,k),sample_space(:,:,k+1)...
