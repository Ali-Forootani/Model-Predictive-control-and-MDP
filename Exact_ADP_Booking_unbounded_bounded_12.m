function [Decision] = Exact_ADP_Booking_unbounded_bounded_12(state,N,m,D_k,...
D_k_p,F_k,F_k_p,lambda_max,lambda_min,mu_max,mu_min,C,r_k,r_k_p)
%%
...
while k>= 1
    ...
    if norm(D_k_p+F_k_p,1)==N & norm(D_k+F_k,1)<N
        %while n1<= NS(1,1)
            [ok] = state_difference_unbounded(state,D_k,F_k);
            if ok == 1
                if sum(state)<=N
    ...
    if norm(D_k+F_k,1)==N & norm(D_k_p+F_k_p,1)< N
        %while n1<= NS(1,1)
                ...
                while a <= m
                    if C(a)~=0
                       ...
                       if state_status==1
                           ...
                           Rev=value_to_go(transition_2,combined_probability,r_k_p);
            ...
            if indicator_rej==1
                ...
                if ok==1
                    ...
                    if state_status==1
                           ...
                           Rev=value_to_go(transition_3,combined_probability_re,r_k_p);
            ...
            if ok==1
                ...
                %Revenue(n1,(m+1),k)=Addition(state,C)+ max_revenue_state;
                %Revenue(n1,1:m,k)=S(n1,1:end);
            ...
            if ok==1 & state_feasibility_3==0
                ...
                while ok_2==0
                    ...
                    if state_status_5==1
                        ...
                        Rev=value_to_go(transition_6,combined_probability_6,r_k_p);
                ...
                if C(a)~=0
                    ...
                    if ok==1
                       ...
                       if state_status==1
                           ...
                           Rev=value_to_go(transition_2_zero,combined_probability,r_k_p);
            ...
            if indicator_rej==1
                ...
                if ok==1
                    ...
                    if state_status==1
                           ...
                           Rev=value_to_go(transition_3_zero,combined_probability_re,r_k_p);
        ...
        if sum(state)==N
            ...
            if ok==1
                ...
                if state_status==1
                           ...
                           Rev_ca=value_to_go(transition_4,combined_probability_ca,r_k_p);
            ...
            if state_feasibility_2==0
                ...
                while ok_2==0
                    ...
                    if er==m & ok_2==0
                        ...
                        combined_probability_6=ones(1,m);
                        Rev=value_to_go(transition_6,combined_probability_6,r_k_p);
                        %Rev=Pair_finding(transition_6,x,NS(1,1),combined_probability_6);
                        %Revenue(n1,(m+1),k)=Addition(S(n1,1:end),C)+Rev;
                        %Revenue(n1,1:m,k)=S(n1,1:end);
                        %Revenue(n1,(m+2),k)=m+2;
                        price=m+2;
            ...
            if norm(D_k+F_k,1) ~= 0
                ...
                if ok==1
                    ...
                    if state_status==1
                           ...
                           transition_3 = shifted_transition_unbounded(transition_re,D_k_p,F_k_p,m);
                           Rev=value_to_go(transition_3,combined_probability_re,r_k_p);
                           %Rev=Pair_finding(transition_3,x,NS(1,1),combined_probability_re);
                           possible_Revenue(1,1+m)=Rev;
                       else
                           possible_Revenue(1,1+m)=0;
                    end
