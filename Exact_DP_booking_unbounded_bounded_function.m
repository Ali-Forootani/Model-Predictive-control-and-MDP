function [Revenue S] = Exact_DP_booking_unbounded_bounded_function(N,m,T,D,F,lambda_max,lambda_min,mu_max,mu_min,C)
            ...
            if indicator_rej==1
                ...
                if ok==1
                    ...
                    if state_status==1
                           ...
                           Rev=Pair_finding(transition_3_zero,x,NS(1,1),combined_probability_re);
                           possible_Revenue(1,1+m)=Rev;
                       else
                           possible_Revenue(1,1+m)=0;
                    end
